...
> The attached PNG illustrates the high‑level workflow between users, the Spring Boot service, Google Drive, MongoDB, and R2 storage. Save the provided image as `docs/api_flow.png` (or update the path below) and refer to it as needed.
